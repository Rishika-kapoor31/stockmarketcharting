...
export class AddCompanyComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    if(this.update){
      this.http.put(`${baseUrl}/admin/companies/update/`+ this.companyToBeUpdated.id, submittedForm).subscribe(
        (response) => {
      ...
      this.http.post(`${baseUrl}/admin/companies/add`, submittedForm).subscribe(
        (response) => {
          console.log(response);
  ...
  getAllSectors(){
    this.http.get(`${baseUrl}/admin/sectors`).subscribe(
      (response) => {
        console.log(response);
  ...
  setStockExchanges(se:String,e:any){
    if(e.checked) {
    // this.addCompanyForm.get('stockExchanges').setValue(this.addCompanyForm.get('stockExchanges').value+se+",");
    console.log(this.addCompanyForm.get('stockExchanges').setValue(this.addCompanyForm.get('stockExchanges').value+se+","));
  }
